...
<head>
    ...
    <link rel="stylesheet" href="../style/mobile/mobile_diario_paciente.css">
    ...
    <main>
        ...
        <div id="tablas">
                ...
                ######################### MUESTREO CONSULTAS ####################################
                    ...
                    <form method='post'>
                        <input type="date" name="fecha_<?php echo($fila['id_con']) ?>" value="<?php echo($fila['fecha']) ?>" /><!-- muestra la fecha y su name se relaciona con su id -->
                        <input type="text" name="motivo_<?php echo($fila['id_con']) ?>" value="<?php echo($fila['motivo']) ?>"/><!-- muestra la fecha y su name se relaciona con su id -->
                        <input type="text" name="especialidad_<?php echo($fila['id_con']) ?>" value="<?php echo($fila['especialidad']) ?>"/><!-- muestra la fecha y su name se relaciona con su id -->
                        <a href="mobile_eliminar_consulta.php?id=<?php echo($fila['id_con']); ?>">Eliminar</a><!--Aca esta el link para eliminar esta fila de consulta -->
                        <input type="submit" name="actualizar" value="Actualizar"><!--Actualiza los campos mediante el name 'actualizar' -->
                    </form>
                <?php } } 
                #################### FIN DE MUESTREO DE CONSULTAS ##############################?>
                    
        <form method="post">
            <!--FILA SOLO PARA QUE EL USUARIO AGREGE MAS CONSULTAS SI LO DESEA-->
            <p>Fecha</p>
            <input type="date" name="fecha" class="input-field">
            <p>Motivo</p>
            <input type="text" name="motivo" class="input-field">
            <p>Especialidad</p>
            <input type="text" name="especialidad">
            <input type="submit" name="guardado" value="Agregar Consulta">
        </div>
                        ...
                        <?php for($i=0; $i < count($lista_e);$i++){//RECORRO EL ARRAY DE ENFERMEDADES ?>
                            ...
                            <li type="square">
                                ...
                                <div class="lista-enfermedad">
                                    ...
                                    <a href="mobile_eliminar_enfermedad.php?id=<?php echo($fila['id_diario'] . "," . $lista_e[$i]); ?>">Eliminar</a>
                                </div>
                            </li>
                        <?php } } ?>
