...
<body>
    ...
    <main>
        ...
        <table class="tablas">
            <tr>
                ...
                ######################### MUESTREO CONSULTAS ####################################
                    ...
                    <form method='post'>
                    <tr>
                        <td><input type="date" name="fecha_<?php echo($fila['id_con']) ?>" value="<?php echo($fila['fecha']) ?>" />
                    
                    </td><!-- muestra la fecha y su name se relaciona con su id -->

                        <td><input type="text" name="motivo_<?php echo($fila['id_con']) ?>" value="<?php echo($fila['motivo']) ?>"/></td>
                        
                        <!-- muestra la fecha y su name se relaciona con su id -->


                        <td><input type="text" name="especialidad_<?php echo($fila['id_con']) ?>" value="<?php echo($fila['especialidad']) ?>"/>
                    
                    </td><!-- muestra la fecha y su name se relaciona con su id -->

                
                    <div class="eliminarconsulta"> 
                        <td><a href="eliminar_consulta.php?id=<?php echo($fila['id_con']); ?>">Eliminar</a></td>
                        <!--Aca esta el link para eliminar esta fila de consulta -->
                    </div>
        ...
        <form method="post">
            <tr><!--FILA SOLO PARA QUE EL USUARIO AGREGuE MAS CONSULTAS SI LO DESEA-->
